...
const CLIPPER_ADDRESS = '0xb4027EEEa4b2D91616c63Dc3E37075E69f36b457'
const OLD_ADDRESS = '0xF176D56b9B5fB458AE9A223aCc5C3e35402deD12'
...
const CLIPPER_ABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_targetEpoch', type: 'uint256' },
    ],
    name: 'advanceAndRedeemMax',
    outputs: [],
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '_user', type: 'address' },
      { internalType: 'uint256', name: '_epoch', type: 'uint256' },
      { internalType: 'uint256', name: '_couponAmount', type: 'uint256' },
    ],
    name: 'redeem',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_newOffer', type: 'uint256' }],
    name: 'setOffer',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
module.exports = { CLIPPER_ABI, CLIPPER_ADDRESS, DAO_ABI, DAO_ADDRESS }
